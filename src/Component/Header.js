...
export  function Header() {
  ...
  return (
    <header>
      ...
      <nav className="border-b-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-slate-800 ">
        ...
        <div className="flex md:order-2">
          <button onClick={()=>setDarkMode(!darkMode)}  type="button" data-tooltip-target="navbar-search" aria-controls="sun" aria-expanded="false" className=" text-gray-500 dark:text-gray-400  focus:outline-none     text-sm p-2.5 mr-1" >
            {darkMode ? (<BsFillSunFill className="w-6 h-6" />) : (<BsFillMoonFill className="h-6 w-6" />)}
           
            
          </button>
          <button onClick={()=>setHidden(!hidden)} type="button" data-collapse-toggle="navbar-search-example-tooltip-dark-mode-toggle" aria-controls="navbar-search" aria-expanded="false" className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1" >
